            ...
            try {
                ...
                if(ofertas.isEmpty()){
                    ...
                    for(int i = 0; i <= ofertas.getTamanho() + 1; i++){
                        ...
                        corpo += String.format("%-45s", oferta.getUsuario().getEmail());
                ...
                if(demandas.isEmpty()){
                    ...
                    for(int i = 0; i <= demandas.getTamanho() + 1; i++){
                        ...
                        corpo += String.format("%06.2f", demanda.getSalario());
                        corpo += String.format("%-45s", demanda.getUsuario().getEmail());
                ...
                trailer += String.format("%010d", contDemandas);
